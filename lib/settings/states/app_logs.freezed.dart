...
mixin _$AppLogsState {
 ...
 List<AppLog> get logs; List<String> get selected;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppLogsState&&const DeepCollectionEquality().equals(other.logs, logs)&&const DeepCollectionEquality().equals(other.selected, selected));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(logs),const DeepCollectionEquality().hash(selected));
...
@useResult
$Res call({
 List<AppLog> logs, List<String> selected
});
...
/// Create a copy of AppLogsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? logs = null,Object? selected = null,}) {
  return _then(AppLogsState(
logs: null == logs ? _self.logs : logs // ignore: cast_nullable_to_non_nullable
as List<AppLog>,selected: null == selected ? _self.selected : selected // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<AppLog> logs,  List<String> selected)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppLogsState() when $default != null:
return $default(_that.logs,_that.selected);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<AppLog> logs,  List<String> selected)  $default,) {final _that = this;
switch (_that) {
case _AppLogsState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<AppLog> logs,  List<String> selected)?  $default,) {final _that = this;
switch (_that) {
case _AppLogsState() when $default != null:
return $default(_that.logs,_that.selected);case _:
  return null;
...
class _AppLogsState implements AppLogsState {
  const _AppLogsState({ List<AppLog> logs = const [],  List<String> selected = const []}): _logs = logs,_selected = selected;
  

 final  List<AppLog> _logs;
@override@JsonKey() List<AppLog> get logs {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AppLogsState&&const DeepCollectionEquality().equals(other._logs, _logs)&&const DeepCollectionEquality().equals(other._selected, _selected));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_logs),const DeepCollectionEquality().hash(_selected));
...
/// Create a copy of AppLogsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? logs = null,Object? selected = null,}) {
  return _then(_AppLogsState(
logs: null == logs ? _self._logs : logs // ignore: cast_nullable_to_non_nullable
as List<AppLog>,selected: null == selected ? _self._selected : selected // ignore: cast_nullable_to_non_nullable
as List<String>,
  ));
}
