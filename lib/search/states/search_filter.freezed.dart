...
mixin _$SearchFiltersState {
 ...
 dynamic get date; dynamic get duration; dynamic get sortBy;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SearchFiltersState&&const DeepCollectionEquality().equals(other.date, date)&&const DeepCollectionEquality().equals(other.duration, duration)&&const DeepCollectionEquality().equals(other.sortBy, sortBy));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(date),const DeepCollectionEquality().hash(duration),const DeepCollectionEquality().hash(sortBy));
...
@useResult
$Res call({
 dynamic date, dynamic duration, dynamic sortBy
});
...
/// Create a copy of SearchFiltersState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? date = freezed,Object? duration = freezed,Object? sortBy = freezed,}) {
  return _then(SearchFiltersState(
date: freezed == date ? _self.date : date // ignore: cast_nullable_to_non_nullable
as dynamic,duration: freezed == duration ? _self.duration : duration // ignore: cast_nullable_to_non_nullable
as dynamic,sortBy: freezed == sortBy ? _self.sortBy : sortBy // ignore: cast_nullable_to_non_nullable
as dynamic,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( dynamic date,  dynamic duration,  dynamic sortBy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SearchFiltersState() when $default != null:
return $default(_that.date,_that.duration,_that.sortBy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( dynamic date,  dynamic duration,  dynamic sortBy)  $default,) {final _that = this;
switch (_that) {
case _SearchFiltersState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( dynamic date,  dynamic duration,  dynamic sortBy)?  $default,) {final _that = this;
switch (_that) {
case _SearchFiltersState() when $default != null:
return $default(_that.date,_that.duration,_that.sortBy);case _:
  return null;
...
class _SearchFiltersState implements SearchFiltersState {
  const _SearchFiltersState({this.date = SearchDate.any, this.duration = SearchDuration.any, this.sortBy = SearchSortBy.relevance});
  

@override@JsonKey() final  dynamic date;
@override@JsonKey() final  dynamic duration;
@override@JsonKey() final  dynamic sortBy;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SearchFiltersState&&const DeepCollectionEquality().equals(other.date, date)&&const DeepCollectionEquality().equals(other.duration, duration)&&const DeepCollectionEquality().equals(other.sortBy, sortBy));
}
...
/// Create a copy of SearchFiltersState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? date = freezed,Object? duration = freezed,Object? sortBy = freezed,}) {
