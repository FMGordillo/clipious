...
mixin _$DownloadManagerState {
 ...
 List<DownloadedVideo> get videos; Map<String, DownloadProgress> get downloadProgresses;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DownloadManagerState&&const DeepCollectionEquality().equals(other.videos, videos)&&const DeepCollectionEquality().equals(other.downloadProgresses, downloadProgresses));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(videos),const DeepCollectionEquality().hash(downloadProgresses));
...
@useResult
$Res call({
 List<DownloadedVideo> videos, Map<String, DownloadProgress> downloadProgresses
});
...
/// Create a copy of DownloadManagerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? videos = null,Object? downloadProgresses = null,}) {
  return _then(DownloadManagerState(
videos: null == videos ? _self.videos : videos // ignore: cast_nullable_to_non_nullable
as List<DownloadedVideo>,downloadProgresses: null == downloadProgresses ? _self.downloadProgresses : downloadProgresses // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<DownloadedVideo> videos,  Map<String, DownloadProgress> downloadProgresses)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DownloadManagerState() when $default != null:
return $default(_that.videos,_that.downloadProgresses);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<DownloadedVideo> videos,  Map<String, DownloadProgress> downloadProgresses)  $default,) {final _that = this;
switch (_that) {
case _DownloadManagerState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<DownloadedVideo> videos,  Map<String, DownloadProgress> downloadProgresses)?  $default,) {final _that = this;
switch (_that) {
case _DownloadManagerState() when $default != null:
return $default(_that.videos,_that.downloadProgresses);case _:
  return null;
...
class _DownloadManagerState extends DownloadManagerState {
  const _DownloadManagerState({ List<DownloadedVideo> videos = const [],  Map<String, DownloadProgress> downloadProgresses = const {}}): _videos = videos,_downloadProgresses = downloadProgresses,super._();
  

 final  List<DownloadedVideo> _videos;
@override@JsonKey() List<DownloadedVideo> get videos {
...
@override@JsonKey() Map<String, DownloadProgress> get downloadProgresses {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DownloadManagerState&&const DeepCollectionEquality().equals(other._videos, _videos)&&const DeepCollectionEquality().equals(other._downloadProgresses, _downloadProgresses));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_videos),const DeepCollectionEquality().hash(_downloadProgresses));
...
/// Create a copy of DownloadManagerState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? videos = null,Object? downloadProgresses = null,}) {
  return _then(_DownloadManagerState(
videos: null == videos ? _self._videos : videos // ignore: cast_nullable_to_non_nullable
as List<DownloadedVideo>,downloadProgresses: null == downloadProgresses ? _self._downloadProgresses : downloadProgresses // ignore: cast_nullable_to_non_nullable
as Map<String, DownloadProgress>,
  ));
}
